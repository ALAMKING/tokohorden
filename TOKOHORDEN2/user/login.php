...
// Cek jika sudah login - PERBAIKAN: Gunakan path yang benar
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* TAMBAHAN: Link kembali ke beranda */
        .back-home {
            margin-top: 20px;
        ...
        <div class="login-header">
            <div class="brand-logo">
                ...
                <p>Login Area Pelanggan</p>
                    ...
                    <!-- TAMBAHAN: Link switch ke admin -->
                    <div class="switch-admin" style="margin-top: 15px; padding: 12px; background: var(--light-cream); border-radius: var(--radius); text-align: center;">
                <p style="margin: 0; font-size: 0.85rem; color: var(--brown);">
                    Admin? 
                    <a href="../admin/login.php" style="color: var(--gold); font-weight: 600; text-decoration: none;">
                        Login sebagai Admin
                    </a>
                </p>
            </div>
            ...
            <form method="POST">
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="email" name="email" class="form-control" placeholder="Masukkan email" required value="budi@email.com">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="password" name="password" class="form-control" placeholder="Masukkan password" required value="password">
                    </div>
                </div>
